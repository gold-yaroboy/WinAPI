...
CONST INT g_i_BUTTON_SIZE = 48;
CONST INT g_i_INTERVAL = 2;
CONST INT g_i_BUTTON_DOUBLE_SIZE = g_i_BUTTON_SIZE * 2 + g_i_INTERVAL;
CONST INT g_i_DISPLAY_WIDTH = g_i_BUTTON_SIZE * 5 + g_i_INTERVAL * 4;
CONST INT g_i_DISPLAY_HEIGHT = 48;
CONST INT g_i_FONT_HEIGHT = g_i_BUTTON_SIZE;
CONST INT g_i_FONT_WIDTH = g_i_FONT_HEIGHT / 2;
CONST INT g_i_START_X = 12;
CONST INT g_i_START_Y = 12;
CONST INT g_i_BUTTON_START_X = g_i_START_X;
CONST INT g_i_BUTTON_START_Y = g_i_START_Y + g_i_DISPLAY_HEIGHT + g_i_INTERVAL * 2;

CONST INT g_i_WINDOW_WIDTH = g_i_DISPLAY_WIDTH + g_i_START_X * 2 + 16;
CONST INT g_i_WINDOW_HEIGHT = g_i_DISPLAY_HEIGHT + g_i_INTERVAL + (g_i_BUTTON_SIZE + g_i_INTERVAL) * 4 + 58;
...
LRESULT CALLBACK WndProc(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_CREATE:
	{
		...
		(
			...
			"Zero.bmp", 
			IMAGE_BITMAP, 
			g_i_BUTTON_DOUBLE_SIZE, g_i_BUTTON_DOUBLE_SIZE, 
			LR_LOADFROMFILE
		);
